/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ab0be663e53c4f803d63b57b9499abc7)
// Runtime types generated with workerd@1.20260820.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PAIRING_ROOMS: DurableObjectNamespace<import("./server/index").PairingRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "PairingRoom";
	}
